...
$(function()
	{
		...
		//alert(location);
		if(location=='blog.php') $("#blog").attr('class','active');
		if(location=='team.php') $("#team").attr('class','active');
		if(location=='bio.php') $("#bio").attr('class','active');
		if(location=='company.php') $("#company").attr('class','active');
...
<div class="Header_top"><div class="Header_lefttop"><img src="images/icon.jpg" alt="" border="0" align="absmiddle" style="padding-right:5px;" /> 208.754.7402 <img src="images/icon1.jpg" alt="" border="0" align="absmiddle" style="padding:0 5px 0 10px;" /><a href="mailto:director@betoparedes.com">director@betoparedes.com</a></div>
...
<li><a href="blog.php" id="blog" target="_self">Beto’s Blog</a></li>
